  ...
  <section id="contact" class="py-20 pb-50 px-4">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <div class="flex justify-center space-x-6 {contactSection ? 'animate-bounce' : ''} ">
        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=jial7150@gmail.com" target="_blank" class="flex items-center gap-1 text-lg text-gray-600 dark:text-gray-300 hover:text-purple-800" aria-label="Send me an email">
        ...
        <a href="https://github.com/JiaJasonLiu" target="_blank" class="flex items-center gap-1 text-lg text-gray-600 dark:text-gray-300 hover:text-purple-800 {contactSection ? 'animate-bounce' : ''}" aria-label="Visit my GitHub profile">
        ...
        <a href="https://www.linkedin.com/in/jia-sheng-liu-9a8a23224/" target="_blank" class="flex items-center gap-1 text-lg text-gray-600 dark:text-gray-300 hover:text-purple-800" aria-label="Visit my LinkedIn profile">
