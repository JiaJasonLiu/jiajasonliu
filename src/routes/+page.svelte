  ...
  <section id="contact" class="py-20 px-4 ">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <div class="flex justify-center space-x-6">
        ...
        <a href="https://github.com/JiaJasonLiu" target="_blank" class="flex items-center gap-1 text-lg text-gray-600 dark:text-gray-300 hover:text-purple-800" aria-label="Visit my GitHub profile">
