    ...
    <img src="/jiajason.png" alt="JiaJason's Pic" class="md:inline hidden right-0 rounded-full max-h-115 shadow-2xl dark:opacity-75 shadow-indigo-500/30">
     ...
     <div class="text-center">
                ...
                <div class="flex justify-center space-x-6">
                  ...
                  <a href="https://github.com/JiaJasonLiu" target="_blank" class="flex items-center gap-1 text-lg text-gray-600 dark:text-gray-300 hover:text-indigo-800" aria-label="Visit my GitHub profile">
