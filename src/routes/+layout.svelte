...
<footer in:fade={{duration:1500, delay:1400}} class="border-t border-gray-200 dark:border-gray-700 py-10 mt-8">
  <div class="container mx-auto px-4 flex flex-col items-center gap-6">
    <span class="font-lora text-xl text-primary font-semibold"> Jason Liu</span>
    <nav class="flex gap-8">
      <a href="/project" class="text-secondary hover:text-primary transition-colors font-mono text-sm">Projects</a>
      <a href="/writing" class="text-secondary hover:text-primary transition-colors font-mono text-sm">Writing</a>
      <a href="/about" class="text-secondary hover:text-primary transition-colors font-mono text-sm">About</a>
    </nav>
    <div class="flex gap-6">
      <a href="https://github.com/JiaJasonLiu" target="_blank" rel="noopener noreferrer" class="text-secondary hover:text-primary transition-colors" aria-label="GitHub">
      ...
      <a href="https://www.linkedin.com/in/jia-sheng-liu-9a8a23224/" target="_blank" rel="noopener noreferrer" class="text-secondary hover:text-primary transition-colors" aria-label="LinkedIn">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
