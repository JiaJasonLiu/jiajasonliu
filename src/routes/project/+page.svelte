        ...
        <div class="bg-white dark:bg-gray-800  shadow-gray-400 rounded-lg shadow-lg overflow-hidden group hover:shadow-xl transition-shadow duration-300">
            <div class="relative h-48 overflow-hidden">
                ...
                <div class="flex space-x-4">
                    <a href="https://github.com/JiaJasonLiu?tab=repositories" target="_blank" class="text-white hover:text-purple-800 transition-colors" aria-label="View project on GitHub">
